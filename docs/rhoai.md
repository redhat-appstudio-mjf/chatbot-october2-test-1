...
3) Access the `workbench` named `chatbot-october2-test-1-notebook`.
...
5) In the terminal, run `cd chatbot-october2-test-1` to navigate to your sample app's directory.
